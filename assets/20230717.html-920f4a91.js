import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as c,c as l,f as e,a as s,b as a,e as p}from"./app-5a910848.js";const u={},r={href:"https://www.npmjs.com/package/vite-plugin-version-mark",target:"_blank",rel:"noopener noreferrer"},d={href:"https://www.npmjs.com/package/git-commit-info-plugin",target:"_blank",rel:"noopener noreferrer"},k={href:"https://juejin.cn/post/7253734111663079484?share_token=6ed05d2d-5782-4fda-a361-988951a9f377",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.npmjs.com/package/vite-plugin-add-commit-info",target:"_blank",rel:"noopener noreferrer"},v={href:"https://github.com/mmdctjj/vite-plugin-add-commit-info",target:"_blank",rel:"noopener noreferrer"};function b(g,n){const t=i("ExternalLinkIcon");return c(),l("div",null,[n[8]||(n[8]=e('<blockquote><p>文章同步在公众号：萌萌哒草头将军，欢迎关注！</p></blockquote><h3 id="需求背景" tabindex="-1"><a class="header-anchor" href="#需求背景" aria-hidden="true">#</a> 需求背景</h3><p>前几天我们的客户对我们组的客户经理提了个需求，每次上线前端页面需要在HTML里给定版本信息，因为我们客户单位会定期爬取版本信息进行汇总展示在大屏。</p><p>版本信息要求如下：</p><ul><li>上线日期</li><li>上线内容描述</li><li>对应git提交ID</li><li>对应项目的版本号</li></ul><h3 id="调研" tabindex="-1"><a class="header-anchor" href="#调研" aria-hidden="true">#</a> 调研</h3><p>我立马想到使用插件，前几天我已经将项目脚手架换成vite了，我找了一圈，发现了几个相似的需求，不过都是直接生成 meta 标签，跟我的需求不符</p><p>（我的需求是让版本信息成为入口标签的属性），</p><p>他们分别是下面几个库，希望可以帮到大家</p>',9)),s("p",null,[s("a",r,[n[0]||(n[0]=a("https://www.npmjs.com/package/vite-plugin-version-mark")),p(t)])]),s("p",null,[s("a",d,[n[1]||(n[1]=a("https://www.npmjs.com/package/git-commit-info-plugin")),p(t)])]),n[9]||(n[9]=s("p",null,"可以满足我的需求的插件基本上没有",-1)),s("p",null,[n[3]||(n[3]=a("推荐上篇 ")),s("a",k,[n[2]||(n[2]=a("面对躺平同事，我开发了一个vite插件，治好了我的精神内耗")),p(t)])]),n[10]||(n[10]=e(`<p>基于前面几次的插件经验，我又打算自己开发插件满足自己的需求。</p><h3 id="实现" tabindex="-1"><a class="header-anchor" href="#实现" aria-hidden="true">#</a> 实现</h3><p>下面是我本地的初始版本，使用 vite 特有的钩子 transformIndexHtml ，</p><p>我们通过 childProcess 同步的方式访问 git 信息，</p><p>通过 jsdom 库将html字符串转化为 dom 对象插入信息，最后序列化为字符串返回即可。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> childProcess <span class="token keyword">from</span> <span class="token string">&#39;child_process&#39;</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/09795967d9c44b33ab34b71c7643768d~tplv-k3u1fbpfcp-watermark.image?" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h3 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h3><p>我已经开源了，感兴趣的小伙伴可以下载体验一番。</p>`,19)),s("p",null,[n[5]||(n[5]=a("npm地址：")),s("a",m,[n[4]||(n[4]=a("https://www.npmjs.com/package/vite-plugin-add-commit-info")),p(t)])]),s("p",null,[n[7]||(n[7]=a("github地址：")),s("a",v,[n[6]||(n[6]=a("https://github.com/mmdctjj/vite-plugin-add-commit-info")),p(t)])]),n[11]||(n[11]=s("p",null,"今天的分享就到这了，文章中有纰漏的地方欢迎指正。",-1))])}const w=o(u,[["render",b],["__file","20230717.html.vue"]]);export{w as default};
